...
if __name__ == "__main__":
    ...
    pd.to_pickle(model_input, '/Users/yuxuanyang/Downloads/DSIN-master/model_input/dien_input_' +
                 str(FRAC) + '_' + str(DIN_SESS_MAX_LEN) + '.pkl')
    pd.to_pickle(data['clk'].values, '/Users/yuxuanyang/Downloads/DSIN-master/model_input/dien_label_' +
                 str(FRAC) + '_' + str(DIN_SESS_MAX_LEN) + '.pkl')
    pd.to_pickle(feature_columns,
                 '/Users/yuxuanyang/Downloads/DSIN-master/model_input/dien_fd_' + str(FRAC) + '_' + str(DIN_SESS_MAX_LEN) + '.pkl', )
