...
if __name__ == "__main__":
    ...
    FILE_NUM = len(
        list(
            filter(lambda x: x.startswith('user_hist_session_' + str(FRAC) + '_din_'), os.listdir('/Users/yuxuanyang/Downloads/DSIN-master/sampled_data/'))))

    print('total', FILE_NUM, 'files')
    for i in range(FILE_NUM):
        user_hist_session_ = pd.read_pickle(
            '/Users/yuxuanyang/Downloads/DSIN-master/sampled_data/user_hist_session_' + str(FRAC) + '_din_' + str(i) + '.pkl')
    ...
    pd.to_pickle(model_input, '/Users/yuxuanyang/Downloads/DSIN-master/model_input/din_input_' +
                 str(FRAC) + '_' + str(DIN_SESS_MAX_LEN) + '.pkl')
    pd.to_pickle([np.array(sess_input_length)], '/Users/yuxuanyang/Downloads/DSIN-master/model_input/din_input_len_' +
                 str(FRAC) + '_' + str(DIN_SESS_MAX_LEN) + '.pkl')

    pd.to_pickle(data['clk'].values, '/Users/yuxuanyang/Downloads/DSIN-master/model_input/din_label_' +
                 str(FRAC) + '_' + str(DIN_SESS_MAX_LEN) + '.pkl')
    pd.to_pickle(feature_columns,
                 '/Users/yuxuanyang/Downloads/DSIN-master/model_input/din_fd_' + str(FRAC) + '_' + str(DIN_SESS_MAX_LEN) + '.pkl', )
