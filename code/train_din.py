...
if __name__ == "__main__":
    ...
    dnn_feature_columns = pd.read_pickle('/Users/yuxuanyang/Downloads/DSIN-master/model_input/din_fd_' +
                                         str(FRAC) + '_' + str(SESS_MAX_LEN) + '.pkl')
    model_input = pd.read_pickle(
        '/Users/yuxuanyang/Downloads/DSIN-master/model_input/din_input_' + str(FRAC) + '_' + str(SESS_MAX_LEN) + '.pkl')
    label = pd.read_pickle('/Users/yuxuanyang/Downloads/DSIN-master/model_input/din_label_' +
                           str(FRAC) + '_' + str(SESS_MAX_LEN) + '.pkl')
