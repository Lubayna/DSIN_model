...
if __name__ == "__main__":
   ...
   # print(label)
    ...
    print('train_user_id')
    print(type(train_input['userid']))
    print(len(train_input['userid']))
    print(train_input['userid'])
    ...
    model = DSIN(dnn_feature_columns, sess_feature_list, sess_max_count=sess_count, bias_encoding=True,
                 ...
                 dnn_dropout=0.2, dnn_use_bn=False, l2_reg_dnn=0, l2_reg_embedding=1e-06, seed=1024, task='binary')
